...
export default function Register() {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post('http://localhost:6006/register', formData);
  ...
  return (
    ...
    <div className="p-4 border rounded shadow" style={{ width: '350px' }}>
        <div className='d-flex justify-content-center gap-0 mb-5'>
            ...
            <h3 className="align-self-center mt-2">Register</h3>
        </div>
        <form onSubmit={handleSubmit}>
            ...
            <button type="submit" className="btn btn-primary w-100" style={{backgroundColor:"rgb(105, 0, 167)", border:"1px solid rgb(105, 0, 167"}}>Register</button>
        </form>
        <p className="text-center mt-2">Already have an account? 
            <Link to='/login' style={{color:"rgb(105, 0, 167)"}}>Login</Link>
            {/* <a href="" >Login</a> */}
        </p>
    </div>
</div> :
